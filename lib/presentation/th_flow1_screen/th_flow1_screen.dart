...
class ThFlow1Screen extends StatelessWidget {
  const ThFlow1Screen({Key? key}) : super(key: key);
                    ...
                    child: SizedBox(
                        ...
                        child: Stack(alignment: Alignment.topCenter, children: [
                          ...
                          CustomImageView(
                              ...
                              alignment: Alignment.bottomRight,
                              margin:
                                  EdgeInsets.only(right: 14.h, bottom: 327.v),
                              onTap: () {
